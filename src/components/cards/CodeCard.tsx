  ...
  return (
    <BentoCard className="p-6 sm:p-8 h-full" delay={360}>
      <div className="flex items-center gap-3 mb-5">
        <span className="text-[10px] font-mono text-base/20 tracking-widest">07</span>
        <span className="w-6 h-px bg-base/10" />
        <span className="text-[10px] font-mono text-base/30 tracking-widest uppercase">{t.code.title}</span>
      </div>
      ...
      <a
        ...
        className="group flex items-center gap-2 text-xs text-base/30 hover:text-base/60 transition-colors duration-200"
      >
